...
![mvn verify](https://github.com/hampelratte/svdrp4j/actions/workflows/mvn-verify.yaml/badge.svg)
...
-----------------------
svdrp4j is build with Maven. You can find the binary, source and javadoc packages in
my [maven repository](http://hampelratte.org/maven/releases/org/hampelratte/svdrp4j/).
